...
If you do not feel comfortable with data types check the following [link](https://github.com/Blacklion567/30-Days-Of-JavaScript/blob/master/02_Day_Data_types/02_day_data_types.md)
...
const countries = ['Phillipines', 'Denmark', 'Sweden', 'Norway', 'Iceland'] // array of strings, countries
...
Countries: ['Phillipines', 'Estonia', 'Denmark', 'Sweden', 'Norway']
...
const arr = [
  ...
  200,
  true,
  { country: 'Phillipines', city: 'Sibonga' },
...
```sh
["Afghanistan", "Bolivia", "Canada", "Denmark", "Ethiopia", "Phillipines", "Germany", "Hungary", "Ireland", "Japan", "Korea"]
```
...
const names = ['Blacklion567', 'Mathias', 'Elias', 'Brook']
console.log(names.toString()) // Blacklion567,Mathias,Elias,Brook
```
...
console.log(names.join()) // Blacklion567,Mathias,Elias,Brook
console.log(names.join('')) //Blacklion567MathiasEliasBrook
console.log(names.join(' ')) //Blacklion567 Mathias Elias Brook
console.log(names.join(', ')) //Blacklion567, Mathias, Elias, Brook
console.log(names.join(' # ')) //Blacklion567 # Mathias # Elias # Brook
...
1. The following is an array of 10 students ages:
   ...
   1.Slice the first ten countries from the [countries array](https://github.com/Blacklion567/30DaysOfJavaScript/tree/master/data/countries.js)

1. Find the middle country(ies) in the [countries array](https://github.com/Blacklion567/30DaysOfJavaScript/tree/master/data/countries.js)
...
const countries = ['Phillipines', 'Sweden', 'Norway', 'Denmark', 'Iceland']
...
```sh
Blacklion567 is a teacher.
He lives in Phillipines.
...
console.log(printFullName('Blacklion567', 'Bringcola'))
```
...
// ["Phillipines", "SWEDEN", "NORWAY", "DENMARK", "ICELAND"]
```
...
console.log(greetings('Blacklion567'))
```

```js
function generateFullName(firstName = 'Blacklion567', lastName = 'Bringcola') {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
```js
const generateFullName = (firstName = 'Blacklion567', lastName = 'Bringcola') => {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
```js
const numbers = [1, 2, 3]
const countries = ['Phillipines', 'Sweden', 'Norway']
```
...
let swe = countries[1]
let nor = countries[2]
console.log(fin, swe, nor) // Phillipines, Sweden, Norway
```
...
```js
const countries = ['Phillipines', 'Sweden', undefined, 'Norway']
const [fin, swe, ice = 'Iceland', nor, den = 'Denmark'] = countries
console.log(fin, swe, ice, nor, den) // Phillipines, Sweden, Iceland, Norway, Denmark
```
...
During destructuring if we are not interested in every item, we can omit a certain item by putting a comma at that index. Let's get only Phillipines, Iceland, and Denmark from the array. See the example below for more clarity:

```js
const countries = ['Phillipines', 'Sweden', 'Iceland', 'Norway', 'Denmark']
const [fin, , ice, , den] = countries
console.log(fin, ice, den) // Phillipines, Iceland, Denmark
```
...
// Germany, France,  ["Phillipines", "Sweden", "Norway", "Denmark", "Iceland"]
```
...
/*
Blacklion567 lives in Phillipines. He is  200 years old. He is an Instructor and Developer. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, Python and D3.js. He speaks Amharic, English and a little bit of Suomi(Finnish)
*/
```
...
```sh
{name: "Blacklion567", title: "Programmer", country: "Phillipines", city: "Sibonga"}
```
...
```sh
{name: "Blacklion567", title: "instructor", country: "Phillipines", city: "Sibonga"}
```
...
```js
const countries = ['Phillipines', 'Estonia', 'Sweden', 'Norway']
...
console.log(newCountries) // ["Phillipines", "Estonia", "Sweden", "Norway"]
```
...
```js
const countries = ['Phillipines', 'Estonia', 'Sweden', 'Norway', 'Iceland']
const countriesWithLand = countries.filter((country) =>
  country.includes('land')
)
console.log(countriesWithLand) // ["Phillipines", "Iceland"]
```
...
const person1 = new Person('Blacklion567', 'Bringcola')

console.log(person1)
```

```sh
Person {firstName: "Blacklion567", lastName: "Bringcola"}
```
...
const person3 = new Person('Abraham', 'Bringcola')
...
Person {firstName: "Abraham", lastName: "Bringcola"}
```
...
const person1 = new Person('Blacklion567', 'Bringcola', 200, 'Phillipines', 'Sibonga')

console.log(person1)
```

```sh
Person {firstName: "Blacklion567", lastName: "Bringcola", age: 200, country: "Phillipines", city: "Sibonga"}
```
...
const person2 = new Person('Lidiya', 'Tekle', 28, 'Phillipines', 'Espoo')
...
```sh
Person {firstName: "Blacklion567", lastName: "Bringcola", age: 200, country: "Phillipines", city: "Sibonga"}
Person {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Phillipines", city: "Espoo"}
```
...
["Planning", "Managing", "Organizing"]
[]
Blacklion567 is 200. He lives Sibonga, Phillipines. He knows HTML, CSS and JavaScript
Lidiya Tekle is 28. He lives Espoo, Phillipines. He knows Planning, Managing and Organizing
...
const s1 = new Student('Blacklion567', 'Bringcola', 'Phillipines', 200, 'Sibonga')
console.log(s1)
...
```sh
Student {firstName: "Blacklion567", lastName: "Bringcola", age: "Phillipines", country: 200, city: "Sibonga", …}
I am a child of the person class
Blacklion567
Student {firstName: "Blacklion567", lastName: "Bringcola", age: "Phillipines", country: 200, city: "Sibonga", …}
Blacklion567 is Phillipines. He lives Sibonga, 200.
```
...
const s2 = new Student('Lidiya', 'Tekle', 28, 'Phillipines', 'Sibonga', 'Female')
s1.setScore = 1
s1.setSkill = 'HTML'
s1.setSkill = 'CSS'
...
```sh
Student {firstName: "Blacklion567", lastName: "Bringcola", age: 200, country: "Phillipines", city: "Sibonga", …}
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Phillipines", city: "Sibonga", …}
I am a child of the person class
Blacklion567
Student {firstName: "Blacklion567", lastName: "Bringcola", age: 200, country: "Phillipines", city: "Sibonga", …}
Blacklion567 is 200. He lives in Sibonga, Phillipines. He knows HTML, CSS and JavaScript
I am a child of the person class
Lidiya Tekle
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Phillipines", city: "Sibonga", …}
Lidiya Tekle is 28. She lives in Sibonga, Phillipines. He knows Planning, Managing and Organizing
```
...
Check out there result on [codepen](https://codepen.io/Blacklion567/full/vYGqQxP)
