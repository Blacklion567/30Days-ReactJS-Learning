...
getUserInfo('Blacklion567', 'Chrisimos', 'Philippines')
...
<User firstName = 'Blacklion567', lastName='Chrisimos' country = 'Philippines' />
```
...
// Function to display time in Mon date, year format eg Aug 04 2023
const showDate = (time) => {
  const months = [
    'January',
    'February',
